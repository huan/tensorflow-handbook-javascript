...
function seq2seqModel (
  ...
  */
  ...
  // console.log('decoder_outputs.shape', decoder_outputs.shape)
  // console.log('decoder_dense_outputs.shape', decoder_dense_outputs.shape)
